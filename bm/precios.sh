...
curl -b cookies.txt \
  --data '{"aEstadoTabla":[{"TablaNombre":"tbFuturos","FiltroEspecies":"","PagActualNro":"0","FilasxPagina":10,"MensajeNro":0,"HashCode":371857150},{"TablaNombre":"tbOpciones","FiltroEspecies":"","PagActualNro":"2","FilasxPagina":10,"MensajeNro":42662,"HashCode":-1717001204}]}' \
  'http://www.bolsar.com/VistasDL/PaginaLideres.aspx/GetDataPack' \
  -H 'Host: www.bolsar.com' \
  -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:33.0) Gecko/20100101 Firefox/33.0' \
  -H 'Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8' \
